        ...
        <section className="self-stretch flex flex-row items-center justify-between min-h-[171px] gap-[20px] text-left text-[12.4px] text-dimgray font-med mq675:flex-wrap">
          ...
          <div className="flex flex-row items-center justify-start py-5 px-0 gap-[8px] text-[28px]">
            <img
              ...
              src="/frame-6.svg"
            />
            <h3 className="m-0 relative text-inherit font-semibold font-inherit text-transparent !bg-clip-text [background:linear-gradient(180deg,_#06286e,_#164ec0)] [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] mq450:text-[22px]">
              Create Flashcard
            </h3>
          </div>
        </section>
